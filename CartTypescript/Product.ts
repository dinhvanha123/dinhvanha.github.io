export class Product {
	...
	public set image(v : string) {this._image = v;}
	public get summary() : string {return this._summary;}
	public set summary(v : string) {this._summary = v;}
	public get price() : number {return this._price;}
	public set price(v : number) {this._price = v;}
	public get canBuy() : boolean {return this._canBuy;}
	public set canBuy(v : boolean) {this._canBuy = v;}
